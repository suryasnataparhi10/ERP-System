...
//                   // Use Redux action only - no direct API call
...
//   // Enhanced filter: include status filter and search
...
const EmployeeList = () => {
  ...
  return (
    <div className="container mt-4">
      ...
      <div
        className=" card d-flex flex-row gap-2 justify-content-start align-items-center mb-3 px-4"
        style={{ height: "90px" }}
      >
